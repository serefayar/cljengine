...
/**
 * This is the extension manager of the Cljengine extension.
 */
public class CljengineManager extends GeneratedCljengineManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CljengineManager.class.getName());
	 ...
	 */
	public static CljengineManager getInstance()
	{
		return (CljengineManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CljengineConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CljengineManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CljengineManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CljengineManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CljengineManager called, current tenant: " + getTenant().getTenantID());
		}
	}
